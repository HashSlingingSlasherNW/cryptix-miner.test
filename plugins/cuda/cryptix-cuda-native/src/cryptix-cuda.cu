            ...
            for (uint8_t i = 0; i < iteration_count; ++i) {
                ...
                if (sha3_hash[3] % 3 == 0) { 
                    ...
                    for (uint8_t j = 0; j < repeat; ++j) {
                        ...
                        if (first_byte % 2 == 0) {
                            sha3_hash[5] = rotate_left(sha3_hash[5], rotation_amount);
                        } else {
                            sha3_hash[5] = rotate_right(sha3_hash[5], rotation_amount);
                        }
                    }
                } 
                    ...
                    for (uint8_t j = 0; j < repeat; ++j) {
                        ...
                        if (first_byte % 2 == 0) {
                            sha3_hash[18] = rotate_left(sha3_hash[18], rotation_amount);
                        } else {
                            sha3_hash[18] = rotate_right(sha3_hash[18], rotation_amount);
                        }
                    }
                }
            }
